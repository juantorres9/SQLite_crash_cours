...
#VERSION 3 Creation tableau2_a FINAL selon la feuille excel avec tu + tnet  avec 4 causes d'arrets  date : 11/07/2016 
CREATE TABLE IF NOT EXISTS tableau2_a(
t2_id INT UNSIGNED NOT NULL AUTO_INCREMENT UNIQUE KEY ,
t2_date DATE NOT NULL,
t2_reference VARCHAR(20) NOT NULL,
...
t2_arret1 DOUBLE(8,4),
t2_arret2 DOUBLE(8,4),
t2_arret3 DOUBLE(8,4),
t2_arret4 DOUBLE(8,4),
...
#V3  = AJOUTER une colonne dans une position specifique entre deux  autres colonnes
ALTER TABLE tableau2_a ADD t2_arret3 DOUBLE(8,4) AFTER t2_arret2;
ALTER TABLE tableau2_a ADD t2_arret4 DOUBLE(8,4) AFTER t2_arret3;
...
#Inserer groupe de données  dasn le systeme d'un seul coupe si l'information n'a pas été creé . 
...
;
#******************************DUPLICATION DE TABLEAU2 *************************************
#Copier la STRUCTURE   plus les INDEXES de le tableau
CREATE TABLE tableau2_a 
LIKE tableau2;
#copier seulement  la DATA  
INSERT tableau2_a
SELECT * FROM tableau2;