...
BEGIN  #1: recuperation de somme de valeurs depuis tableau1
	...
	WHERE 
		reference='ref1'
		AND 
		DATE(datetimes)=DATE_ADD(DATE(NOW()),INTERVAL -0 DAY);#DATE selon tableau1
