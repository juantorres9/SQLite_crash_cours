...
#*****************************La Sauvegarde  d'Information depuis Tableau1_a vers  tableau2_a selon reference1**********************************************
#ETAPE GENERAL:inserer un ensemble de lignes de REFERENCES dans le tableau1_a s'il n'existe pas la DATE ni LA REFERENCE
DELIMITER  |
CREATE PROCEDURE pro_ligne_t2_a()
BEGIN #1: le choix de tableu2_a pour creer les 4 reference si il n'existent pas avec de valeurs par default NULL sauf  t2_id,t2_date,t2_reference,t2_tr et t2_trs
	INSERT INTO tableau2_a(t2_id,t2_date,t2_reference,t2_tr,t2_trs)
	...
	WHERE NOT EXISTS (SELECT * FROM tableau2_a WHERE t2_date =DATE(NOW())) LIMIT 3;
END|
DELIMITER  ;
...
DELIMITER  |
CREATE PROCEDURE  pro1_ref1_t2_a()
...
DELIMITER  |
CREATE PROCEDURE  pro2_ref1_t2_a()
